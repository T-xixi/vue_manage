           ...
           <el-table :data="manyTableData" border stripe>
             ...
             <el-table-column label="操作">
               <template slot-scope="scope">
                ...
                <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeCateById(scope.row.attr_id)">删除</el-button>
               </template>
             </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleInputConfirm (row) {
      // console.log('res=' + row.inputValue.trim().length)
    ...
    showInput (row) {
      ...
      // 让文本框自动获得焦点
      // $nextTick  就是当页面上的元素被重新渲染后才执行回调函数
      this.$nextTick(_ => {
